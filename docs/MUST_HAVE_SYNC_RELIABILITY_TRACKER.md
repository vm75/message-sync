...
| Discord resilience | [#38 Make Discord managed webhooks self-healing](https://github.com/vm75/message-sync/issues/38) | In progress | #34, #37 | `97902fb` (start HEAD) | — | — | Implement per-channel invalidation, serialized repair, and one retry; dependencies #34/#37 are completed |
