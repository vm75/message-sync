...
| Isolation | [#36 Add independent ordered delivery lanes](https://github.com/vm75/message-sync/issues/36) | In progress | #34, #35 | — | — | — | Starting from `8a8d4a7`; inspect the existing router fan-out and add bounded per-endpoint FIFO lanes |
