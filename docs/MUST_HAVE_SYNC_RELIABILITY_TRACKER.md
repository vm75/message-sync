...
| Recovery foundation | [#39 Add common accepted-event checkpoints and recovery coordination](https://github.com/vm75/message-sync/issues/39) | In progress | #35, #37 | Start HEAD `8910d97c70ffbb5814ba6f67e15f80be5321e644` | Implementing generic accepted-event outcomes, contiguous stream checkpoints, and single-flight recovery coordination; assumptions: provider recovery hooks will be added by #40-#42 and use the shared coordinator. | — | Add transport-neutral checkpoint contract and tests |
