...
| Semantics | [#37 Add bounded retries and lifecycle ordering](https://github.com/vm75/message-sync/issues/37) | In progress | #34-#36 | — | — | — | Starting from `2b3e157`; add bounded lane retries and lifecycle ordering/coalescing |
