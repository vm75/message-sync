...
| WhatsApp recovery | [#42 Reconcile WhatsApp HistorySync through recovery checkpoints](https://github.com/vm75/message-sync/issues/42) | In progress | #39 | `6685e85` | Starting HEAD `6685e85`; integrate existing protocol HistorySync with per-endpoint checkpoint metadata, bounded ordered recovery, and single-flight coordination. Dependency #39 is closed. | — | Implement WhatsApp recovery through the existing adapter path; no `whatsapp.db` protocol-state changes |
