...
| Failure contract | [#34 Add privacy-safe delivery failure classification](https://github.com/vm75/message-sync/issues/34) | In progress | #32, #33 | — | — | — | Starting from `7546977`; add the transport-neutral safe failure contract and adapter boundary classification |
