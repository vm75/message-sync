...
| Telegram recovery | [#40 Persist and recover Telegram update offsets](https://github.com/vm75/message-sync/issues/40) | In progress | #39 | `cad17a0` | Implement a single global Telegram update stream backed by the #39 accepted-event checkpoint coordinator; add fake Bot API recovery tests. Assumption: the existing fixed coordinator bounds (200 updates, 24 hours) apply. | — | Starting HEAD `cad17a063adffacf0ac36a341472ce2cf14e9900`; dependency #39 is complete. |
