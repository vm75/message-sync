...
| 6 | [#30](https://github.com/vm75/message-sync/issues/30) | Forum topics, polls, mentions, migrations, and format fallbacks | #28; #29 before related admin behavior | In progress | Started deterministic forum-topic flattening, migration handling, poll/mention/media fallbacks, and privacy-safe unsupported-event behavior. |
