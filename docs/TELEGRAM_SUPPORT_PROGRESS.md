...
| 4 | [#28](https://github.com/vm75/message-sync/issues/28) | Telegram outbound text/media/replies/reactions/edits/deletes | #26, #27 | In progress | Started Telegram outbound lifecycle implementation; reusing canonical copy/reply/reaction/edit/delete routing and transient-media patterns. |
