...
| 3 | [#27](https://github.com/vm75/message-sync/issues/27) | Wire Telegram into multi-adapter canonical router lifecycle | #25, #26 | In progress | Started Telegram application registry/event-loop/config-reload wiring; reusing the existing canonical router and Discord adapter patterns. |
