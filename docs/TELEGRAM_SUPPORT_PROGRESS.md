...
| 5 | [#29](https://github.com/vm75/message-sync/issues/29) | Telegram chat discovery, runtime status, and admin Web UI | #25, #26, #27 | In progress | Started #29: implementing bounded in-memory observed-chat discovery, authenticated Telegram status/chats APIs, and admin UI integration; VERSION unchanged. |
