...
| 2 | [#26](https://github.com/vm75/message-sync/issues/26) | Telegram Bot adapter foundation and long-poll ingress | #25 | In progress | Started Telegram Bot API long-poll adapter foundation, ingress normalization, and privacy-safe lifecycle work. |
