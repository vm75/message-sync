...
| 7 | [#22](https://github.com/vm75/message-sync/issues/22) | Threads/forums, mentions, polls, unsupported-format fallbacks | #20; #21 before UI exposure | In progress | Started deterministic thread/forum mapping and format-fallback implementation; preserving parent-channel aliases and zero-PII persistence. |
