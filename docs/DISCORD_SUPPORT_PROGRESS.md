...
| 3 | [#18](https://github.com/vm75/message-sync/issues/18) | Discord adapter foundation, bot lifecycle, channel event ingestion | #16, #17 | In progress | Started Discord gateway ingress adapter foundation; preserving alias routing, HMAC actor identity, and zero-PII logging/persistence. |
