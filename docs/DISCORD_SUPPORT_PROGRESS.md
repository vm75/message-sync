...
| 6 | [#21](https://github.com/vm75/message-sync/issues/21) | Discord discovery + admin web UI | #17, #18, #19 | In progress | Started Discord status/discovery, managed-webhook readiness, and mixed-transport admin UI work after verifying dependencies #17–#19 are closed completed. |
