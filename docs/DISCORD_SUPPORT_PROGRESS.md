...
| 5 | [#20](https://github.com/vm75/message-sync/issues/20) | Discord outbound text/media/replies/reactions/edits/deletes | #18, #19 | In progress | Started Discord outbound lifecycle implementation; preserving transient sender rendering and zero-PII persistence/logging. |
