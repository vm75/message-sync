...
| 2 | [#64 Recovery: do not advance checkpoints past payload-dependent pending delivery](https://github.com/vm75/message-sync/issues/64) | Complete | #63 | Align source checkpoint advancement with the point where transient payload is genuinely safe to forget. |
| 3 | [#65 Loop prevention: suppress WhatsApp bridge-generated edit/delete lifecycle echoes](https://github.com/vm75/message-sync/issues/65) | Complete | #64 | Terminate bridge-generated WhatsApp lifecycle echoes without suppressing genuine linked-device actions. |
